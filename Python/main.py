...
def main():
    ...
    point = score.Scoreboard("data/UID.csv","TA team")
    interf = interface.interface()         # the part of calling interface.py was commented out.

    # Mode 0: for treasure-hunting, which encourages you to hunt as many scores as possible.
    if (sys.argv[1] == '0'):
